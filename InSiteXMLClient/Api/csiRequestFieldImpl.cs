...
namespace Camstar.XMLClient.API
{
  internal class CsiRequestField : CsiField, ICsiRequestField, ICsiField, ICsiXmlElement
    ...
    public void RequestUserDefinedFields() => CsiXmlHelper.FindCreateSetValue((ICsiXmlElement) this, "__userDefinedFields", (string) null);
    ...
    public void RequestFieldDefinition()
    {
      ...
      CsiXmlHelper.FindCreateSetValue((ICsiXmlElement) csiMetaDataImpl, "__fieldDef", (string) null);
    }
    ...
    public void RequestDefaultValue() => CsiXmlHelper.FindCreateSetValue((ICsiXmlElement) this, "__defaultValue", (string) null);
