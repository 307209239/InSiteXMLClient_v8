...
namespace Camstar.XMLClient.API
{
    internal class CsiFieldType : CsiXmlElement, ICsiFieldType, ICsiXmlElement
    {
        ...
        public virtual string GetSpecificType() => this.FindChildByName("__specificType") is CsiXmlElement childByName ? CsiXmlHelper.GetFirstTextNodeValue(childByName) : null;

        public virtual string GetNodeType() => this.FindChildByName("__nodeType") is CsiXmlElement childByName ? CsiXmlHelper.GetFirstTextNodeValue(childByName) : null;
