...
namespace Camstar.XMLClient.API
{
  internal class CsiSession : ICsiSession
  {
    ...
    public ICsiDocument CreateDocument(string name)
    {
      lock (this)
      {
        ...
        try
        {
          ...
          ICsiDocument document = (ICsiDocument) new CsiDocument((ICsiSession) this);
          this.mDocuments[(object) name] = (object) document;
    ...
    public ICsiDocument FindDocument(string name) => this.mDocuments[(object) name] as ICsiDocument;

    public void RemoveDocument(string name)
    {
      lock (this)
        this.mDocuments.Remove((object) name);
    }
    ...
    internal ICsiDocument Submit(ICsiDocument document)
    {
      ...
      return (ICsiDocument) new CsiDocument((ICsiSession) this, xml);
    }
  }
}
