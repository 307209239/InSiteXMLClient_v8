...
namespace Camstar.XMLClient.API
{
    ...
    {
        public CsiSelectionValues(ICsiDocument doc, ICsiXmlElement parent) : base(doc, "__selectionValues", parent)
        {
        }

        public CsiSelectionValues(ICsiDocument doc, XmlElement element) : base(doc, element)
        {
        }
