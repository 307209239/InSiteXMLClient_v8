...
namespace Camstar.XMLClient.API
{
  ...
  {
    public CsiList(ICsiDocument doc, XmlElement domElement)
      : base(doc, domElement)
    {
    }

    public CsiList(ICsiDocument doc, string name, ICsiXmlElement parent)
    ...
    {
      Array childrenByName = CsiXmlHelper.GetChildrenByName(this.GetOwnerDocument(), this.GetDomElement(), "__listItem");
      return childrenByName.Length > 0 ? childrenByName : (Array) null;
    }
