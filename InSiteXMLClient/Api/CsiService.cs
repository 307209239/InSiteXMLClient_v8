...
namespace Camstar.XMLClient.API
{
    internal class CsiService : CsiObject, ICsiService, ICsiObject, ICsiField, ICsiXmlElement
    {
        ...
        public virtual string GetUtcOffset() => this.FindChildByName("__utcOffset") is CsiXmlElement childByName ? (childByName.GetDomElement().FirstChild as XmlText).Data : null;
