...
namespace Camstar.XMLClient.API
{
  ...
  {
    public CsiField(ICsiDocument doc, XmlElement domElement)
      : base(doc, domElement)
    {
    }

    public CsiField(ICsiDocument doc, string name, ICsiXmlElement parent)
    ...
    public virtual Array GetFields() => this.GetFields();
