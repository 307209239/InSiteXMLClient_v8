...
namespace Camstar.Exceptions
{
    public class ExceptionUtil
    {
        ...
        public static string GetIdValue(ResourceManager rm, string key) => ExceptionUtil.GetResourceString(rm, ExceptionUtil.GetIdKey(key));
