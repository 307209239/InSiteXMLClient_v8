...
namespace Camstar.Util
{
    public class StringUtil
    {
        ...
        public static bool IsEmptyString(string data) => data == null || data.Length == 0;

        public static bool IsNumericString(string data) => double.TryParse(data, out double d);
        ...
        public static bool FindItem(string item, string items)
        {
            ...
            if (stringList != null && (uint)stringList.Length > 0U)
            {
